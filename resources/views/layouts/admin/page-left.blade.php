					...
					<ul class="nav" id="main-menu">
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a href="active-jobs.html"><i class="active-job fa fa-circle-o-notch" aria-hidden="true"></i>Active Jobs</a>
								</li>
								<li>
									<a href="pending-jobs.html"><i class="pending-job fa fa-circle-o-notch" aria-hidden="true"></i>Pending Jobs</a>
								</li>
							   <li>
									<a href="expire-jobs.html"><i class="expire-job fa fa-circle-o-notch" aria-hidden="true"></i>Expired Jobs</a>
								</li>
							</ul>
						</li>
