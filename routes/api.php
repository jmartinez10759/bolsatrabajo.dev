...
Route::get('admin/menus{?}','Api\MenuApiController@index');
Route::get('admin/menus','Api\MenuApiController@index');
Route::post('admin/menus','Api\MenuApiController@index');
Route::put('admin/menus','Api\MenuApiController@index');
Route::delete('admin/menus','Api\MenuApiController@index');


Route::get('solicitud/permisos/{email}','Api\PermisosApiController@show');
Route::get('solicitud/permisos','Api\PermisosApiController@all');
Route::post('solicitud/permisos','Api\PermisosApiController@create');
Route::put('solicitud/permisos','Api\PermisosApiController@update');
Route::delete('solicitud/permisos','Api\PermisosApiController@destroy');